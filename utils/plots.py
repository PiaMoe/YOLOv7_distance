...
def plot_one_box(x, img, color=None, label=None, heading=None, line_thickness=3, textcolor=[255, 255, 255]):
    ...
    if label:
        ...
        cv2.putText(img, label, (c1[0], c1[1] - 2), 0, tl / 2, textcolor, thickness=tf, lineType=cv2.LINE_AA)
    if heading:
        ...
        cv2.arrowedLine(img, (center_x, center_y), (end_x, end_y), color, thickness=2, line_type=cv2.LINE_AA,
                        tipLength=0.2)
